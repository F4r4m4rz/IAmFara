  ...
  return (
    <div className="rounded-lg border border-term-border bg-term-panel shadow-2xl overflow-hidden font-mono">
      ...
      <div className="p-8 sm:p-12">
        ...
        <div className="mt-3 flex items-center gap-2 text-sm sm:text-base text-term-orange">
          <span>[warning]</span>
        ...
        <div className="mt-3 flex items-center gap-3">
          ...
          <span className="text-xs text-term-muted whitespace-nowrap">
            47% · <T k="comingSoon.building" />
          </span>
        </div>

        <p className="mt-6 max-w-md text-sm sm:text-base text-term-muted leading-relaxed">
          <T k="comingSoon.body" />
        </p>
      </div>
    </div>
